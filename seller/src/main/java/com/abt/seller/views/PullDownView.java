...
import com.abt.seller.views.ScrollOverListView.OnScrollOverListener;

/**
 * 真正实现下拉刷新的是这个控件， ScrollOverListView只是提供触摸的事件等
 */
public class PullDownView extends LinearLayout implements OnScrollOverListener {
	...
	private void initHeaderViewAndFooterViewAndListView(Context context) {
		...
		mHeaderView = LayoutInflater.from(context).inflate(
				R.layout.view_pulldown_header, null);
		...
		mFooterView = LayoutInflater.from(context).inflate(
				R.layout.view_pulldown_footer, null);
